...
new和malloc的区别 -> 深入到operator new的三种情况与malloc中brk与mmap的实现

[c++](https://www.nowcoder.com/jump/super-jump/word?word=c%2B%2B)内联、宏、普通函数的区别（内联和宏分别如何实现）
...
**C++11新特性**: lambda表达式，[c++](https://www.nowcoder.com/jump/super-jump/word?word=c%2B%2B)auto关键字寻找类型的原理    nullptr与constexpr
