...
进程管理
  ...
  [c++](https://www.nowcoder.com/jump/super-jump/word?word=c%2B%2B)11的线程/锁；
...
数据在内核空间和用户空间之间的拷贝 -> 零拷贝问题（讲到CSAPP中浅显的DMA）[9.1 什么是零拷贝？ | 小林coding (xiaolincoding.com)](https://xiaolincoding.com/os/8_network_system/zero_copy.html#sendfile)
