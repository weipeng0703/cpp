...
> - 如果业务有海量消息，消息积压的概率比较大，并且不能接受数据丢失，那么还是用kafka，rabbitmq等专业的消息队列中间件。
...
[消息队列如何保证不丢消息?](https://blog.csdn.net/weixin_50427783/article/details/123152170)
